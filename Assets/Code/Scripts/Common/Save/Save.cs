...
public static class Save
{
    ...
    /// </summary>
    const string _fileName = "game";

    /// <summary>
    /// File format for the save file. Can actually be anything.
    /// </summary>
    const string _fileFormat = ".dat";
    ...
    /// <summary>
    /// Load SaveData to Save.Data. Used in Main.cs
    /// </summary>
...
#region Unencrypted
    ...
    /// </summary>
    public static readonly string UnencryptedPath = Application.persistentDataPath + "/Unencrypted_" +_fileName + ".json";
#elif UNITY_WEBGL
    /// <summary>
    /// Path for unencrypted save data.
    /// </summary>
    ...
    /// Path for unencrypted save data.
    /// </summary>
    public static readonly string UnencryptedPath = "data/data/" + Application.identifier.ToString() + "/files/Unencrypted_"+_fileName + ".json";
#endif    
    ...
    {
        string json = JsonUtility.ToJson(data);
        if (File.Exists(UnencryptedPath)) File.Delete(UnencryptedPath);
