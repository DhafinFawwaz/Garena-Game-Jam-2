...
public class AchoredSpriteRenderer : MonoBehaviour
{
    ...
    [SerializeField] SpriteFitMode _fitMode = SpriteFitMode.FitHeight;


    [SerializeField] Vector2 _viewportPosition = new Vector2(0.5f, 0.5f);
    public Vector2 ViewportPosition { get => _viewportPosition; set => _viewportPosition = value; }
    ...
    public Vector2 AnchoredScreenPosition
    {
        ...
        set
        {
            ...
            _anchorPoint = value;
            Set(_viewportPosition, _anchorPoint);
        }
    }
    void Awake()
    {
    ...
    {
        _viewportPosition = screenPosition;
    ...
    public void SetAnchoredPositionX(float anchoredPositionX) => Set(new Vector2(anchoredPositionX, _viewportPosition.y), new Vector2(anchoredPositionX, _anchorPoint.y));
    public void SetAnchoredPositionY(float anchoredPositionY) => Set(new Vector2(_viewportPosition.x, anchoredPositionY), new Vector2(_anchorPoint.x, anchoredPositionY));
    ...
    public Vector2 GetScreenPosition()
    {
        ...
        return new Vector2(_mainCam.pixelWidth * _viewportPosition.x, _mainCam.pixelHeight * _viewportPosition.y);
    }
